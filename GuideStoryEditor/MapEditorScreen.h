...
//    상단 = [둘러보기][배경][격자▼][추가▼][카메라▼] ... [파일▼]. 드롭다운으로 동작을 묶는다.
//      · 격자  : 스냅 칸 크기 8/16/32 px(풋홀드/포탈/오브젝트 정밀 배치 — 타일 크기와 무관)
...
private:
    ...
    ui::Toolbar  m_quick;      // 상단: [둘러보기][배경] 단일 버튼들
    ...
    ui::Dropdown m_gridMenu;   // 상단: 격자(8/16/32 px 스냅 칸 크기)
